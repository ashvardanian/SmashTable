...
#include "reference_store_defects.hpp"
...
int main(int, char **arguments) {
    ...
    tally += run_test(environment, "std_store_defects.committed_tombstones_are_reclaimable",
                      std_store_defects_committed_tombstones_are_reclaimable);
    tally += run_test(environment, "std_store_defects.vacuum_respects_its_window",
                      std_store_defects_vacuum_respects_its_window);
    tally += run_test(environment, "std_store_defects.erase_reports_and_reclaims_tombstone",
                      std_store_defects_erase_reports_and_reclaims_tombstone);
    tally += run_test(environment, "std_store_defects.erase_range_skips_tombstones",
                      std_store_defects_erase_range_skips_tombstones);
    tally += run_test(environment, "std_store_defects.vacuum_leaves_staged_entries",
                      std_store_defects_vacuum_leaves_staged_entries);
    tally += run_test(environment, "std_store_defects.staged_versions_survive_a_clear",
                      std_store_defects_staged_versions_survive_a_clear);
    tally += run_test(environment, "std_store_defects.commit_reports_success_when_published",
                      std_store_defects_commit_reports_success_when_published);
    tally += run_test(environment, "std_store_defects.staged_entries_keep_one_generation",
    ...
    tally += run_test(environment, "std_store_defects.clear_keeps_generations_running",
                      std_store_defects_clear_keeps_generations_running);
    tally += run_test(environment, "std_store_defects.insert_refuses_with_key_already_exists",
                      std_store_defects_insert_refuses_with_key_already_exists);
    tally += run_test(environment, "std_store_defects.insert_reports_the_stored_element",
                      std_store_defects_insert_reports_the_stored_element);
    tally += run_test(environment, "std_store_defects.insert_after_local_erase_succeeds",
                      std_store_defects_insert_after_local_erase_succeeds);
    tally += run_test(environment, "std_store_defects.validate_refuses_before_publishing",
                      [] { test_validate_refuses_before_publishing<transactional_trivial_map_t>(); });
    tally += run_test(environment, "std_store_defects.publish_cannot_refuse",
                      [] { test_publish_cannot_refuse<transactional_trivial_map_t>(); });
    tally += run_test(environment, "std_store_defects.clear_refuses_while_staged",
                      [] { test_clear_refuses_while_staged<transactional_trivial_map_t>(); });
    tally += run_test(environment, "std_store_defects.stage_refuses_when_already_staged",
                      std_store_defects_stage_refuses_when_already_staged);
    tally += run_test(environment, "std_store_defects.rollback_recovers_what_it_staged",
                      std_store_defects_rollback_recovers_what_it_staged);
    tally += run_test(environment, "std_store_defects.transaction_bounds_skip_locally_erased",
